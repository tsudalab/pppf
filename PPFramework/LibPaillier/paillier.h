...
/*
  ...
  array "buf".
*/
typedef void (*paillier_get_rand_t) ( void* buf, int len, void *usrPtr);
...
paillier_pubkey_t* paillier_pubkey_from_hex(const char* str );
paillier_prvkey_t* paillier_prvkey_from_hex(const char* str,
																						 paillier_pubkey_t* pub );
...
/*
	...
	insufficient.
*/
void paillier_get_rand_devrandom(  void* buf, int len, void *);
void paillier_get_rand_devurandom( void* buf, int len, void *);
